$(function() {
    ...
    c.load("<div class='bef_comment writecode'>&nbsp;*你好,我是平平无奇的凤凰院凶真/div>");
    c.load("<div class='bef_comment writecode'>&nbsp;*El Psy Congroo</div>", 2000);
    ...
    w.load("<ul>");
    w.load("<p><div class='writecode'>姓名：平平无奇的凤凰院凶真</div>");
    w.load("<div class='writecode'>职业：在校大学生</div>");
    w.load("</ul>");
    ...
    w.load("<li class='writecode'>Qzone:<a href='https://user.qzone.qq.com/1754909385' target='_blank'>my.qq.space</a></li>");
    w.load("<li class='writecode'>bilibili:<a href='https://space.bilibili.com/5889484' target='_blank'>my.bilibili.space</a></li>");
    w.load("</ul>");
    w.load("<h1 class='writecode'>理想生活</h1>");
    w.load("<ul>");
    w.load("<p><li class='writecode'>腰缠十万贯，骑鹤下扬州。</li>");
    w.load("</ul>");
    w.load("<h1 class='writecode'>座右铭</h1>");
    w.load("<ul>");
    w.load("<p><li class='writecode'>世事洞明皆学问，人情练达即文章。</li>");
    w.load("</ul>");
    c.load("<p><div class='comment writecode'>/**</div>");
